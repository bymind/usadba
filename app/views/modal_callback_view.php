						...
						<div class="col-xs-10 col-xs-offset-1">
							<form id="callback-form" action="">
								<div class="form-group mb-20">
									...
									<input type="text" id="callback-name" name="name" class="form-control" placeholder="Представьтесь, пожалуйста">
								</div>
								<div class="form-group mb-20">
									<label for="callback-phone">Ваш номер телефона</label>
									<input type="tel" id="callback-phone" class="form-control" name="phone" placeholder="+7 (___) ___-__-__">
