...
<div class="container-fluid">
	...
	<div class="row pt-0 pb-0">
		<div class="col-md-12">
			...
			<h4 class="blocked">
				<a href="/admin/blog/archived" class="disabled">
					Архив
				</a>
			</h4>
		</div>
			...
			<div class="blog-item">
				<div class="poster" style='background-image: url(<?php
					...
					<div class="controls hidden-xs">
						...
						<a href="/admin/blog/archive/<?php echo $post['url'] ?>"  data-target="<?php echo htmlspecialchars($post['title']) ?>" data-id="<?php echo $post['id'] ?>" class="btn-archive">В архив</a>
					</div>
